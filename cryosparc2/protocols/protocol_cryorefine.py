...
from pyworkflow.em.packages.relion.convert import (convertBinaryVol, writeSetOfParticles,readSetOfParticles,
                                                   getVersion, relionToLocation, createItemMatrix, setRelionAttributes)
...
class ProtCryoSparcRefine3D(ProtRefine3D):
    ...
    def convertInputStep(self, particlesId):
        ...
        self.vol_fn = os.path.join(os.getcwd(),convertBinaryVol(self.referenceVolume.get(), self._getTmpPath()))
        print(self.vol_fn)
